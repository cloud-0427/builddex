(() => {
  ...
  function companyRow(company) {
    ...
    tr.append(periodTd, quotaCell(company.packCount, company.packLimit, true, company.companyId), quotaCell(company.deliveryCount, company.deliveryLimit, true, company.companyId));
  ...
  function quotaCell(count, limit, clickable = false, companyId = null) {
    const td = document.createElement("td");
    const wrap = document.createElement("div");
    wrap.className = "quota" + (clickable ? " quota-clickable" : "");
